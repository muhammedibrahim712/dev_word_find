...
const double _kOuterRadius = 13.0;
...
class _CustomRadioState<T> extends State<CustomRadio<T>>
  ...
  void initState() {
    super.initState();
    _painter = _RadioPainter(widget.outerColor);
  }
...
class _RadioPainter extends ToggleablePainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint paint = Paint()
      ..color =
          outerColor ?? Color.lerp(inactiveColor, activeColor, position.value)!
